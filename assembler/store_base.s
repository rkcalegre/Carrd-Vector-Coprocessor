...
ADDI x1, x1, 1    # x1 = x1 + 64 = 64 + 64 = 128
NOP	#from C.NOP
NOP	#from C.NOP
NOP	#from C.NOP
NOP	#from C.NOP
vse16.v v4, x1     # m[x1 = 128] = 15
ADDI x1, x1, 1    # x1 = x1 + 32 = 128 + 32 = 160
NOP	#from C.NOP
NOP	#from C.NOP
NOP	#from C.NOP
NOP	#from C.NOP
vse8.v v4, x1      # m[x1 = 160] = 15
ADDI x1, x1, 1    # x1 = x1 + 16 = 160 + 16 = 176
...
ADDI x1, x1, 1    # x1 = x1 + 64 = 176 + 64 = 240
NOP	#from C.NOP
NOP	#from C.NOP
NOP	#from C.NOP
NOP	#from C.NOP
vse8.v v4, x1      # m[x1 = 240] = 15
ADDI x1, x1, 1    # x1 = x1 + 32 = 240 + 32 = 272
NOP	#from C.NOP
NOP	#from C.NOP
NOP	#from C.NOP
NOP	#from C.NOP
vse32.v v4, x1     # m[x1 = 272] = 15
ADDI x1, x1, 1   # x1 = x1 + 128 = 272 + 128 = 400
...
ADDI x1, x1, 1    # x1 = x1 + 64 = 400 + 64 = 464
NOP	#from C.NOP
NOP	#from C.NOP
NOP	#from C.NOP
NOP	#from C.NOP
vse16.v v4, x1     # m[x1 = 464] = 15
ADDI x1, x1, 1   # x1 = x1 + 128 = 464 + 128 = 592
NOP	#from C.NOP
NOP	#from C.NOP
NOP	#from C.NOP
NOP	#from C.NOP
vse32.v v4, x1     # m[x1 = 592] = 15
ADDI x1, x1, 1   # x1 = x1 + 256 = 592 + 256 = 848
NOP	#from C.NOP
NOP	#from C.NOP
NOP	#from C.NOP
NOP	#from C.NOP
